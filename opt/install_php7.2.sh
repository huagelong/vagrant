...
\cp -rf /vagrant/opt/nginx.conf /opt/nginx/conf/
...
tar xf /vagrant/opt/php-7.2.13.tar.gz -C /usr/src/ && cd /usr/src/php-7.2.13/
...
make -j4 && make install
\cp -rf /vagrant/opt/php.ini /opt/php/lib/php.ini
\cp -rf /vagrant/opt/php-fpm.conf /opt/php/etc/php-fpm.conf
\cp -rf /vagrant/opt/www.conf /opt/php/etc/php-fpm.d/www.conf
...
\cp -rf /usr/src/php-7.2.13/sapi/fpm/init.d.php-fpm /etc/init.d/php-fpm
