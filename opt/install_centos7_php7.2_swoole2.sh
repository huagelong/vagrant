...
tar xf /opt/vagrant/opt/php-7.2.13.tar.gz -C /usr/src/ && cd /usr/src/php-src-php-7.2.13/
...
\cp -rf /usr/src/php-src-php-7.2.13/sapi/fpm/init.d.php-fpm /etc/init.d/php-fpm
