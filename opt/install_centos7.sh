...
tar xf /opt/vagrant/opt/php-7.1.0.tar.gz -C /usr/src/ && cd /usr/src/php-7.1.0/
...
tar xf /opt/vagrant/opt/swoole-src-4.2.1.tar.gz -C /usr/src/ && cd /usr/src/swoole-src-4.2.1/
/opt/php/bin/phpize
